...
built with the Claude Code harness running the **GLM-5.3** and
**GLM-5.3-flash** models, plus Pi Harness and AutoClaw Harness. But every number comes from real simulation
